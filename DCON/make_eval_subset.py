...
the identical episode set.
    ...
    python make_eval_subset.py \
        --src data/datasets/objectnav/gibson/v1.1/val \
        --out data/datasets/objectnav/gibson/v1.1_sub5/val \
        --per-combo 5

Then:
    DCON:  python eval_scene.py run --dataset <out> --out output/sub5 --discrete ...
...
def main():
    ...
    ap.add_argument("--src", default="data/datasets/objectnav/gibson/v1.1/val",
                    help="source split dir (must contain content/ and <split>_info.pbz2)")
    ap.add_argument("--out", default="data/datasets/objectnav/gibson/v1.1_sub5/val",
